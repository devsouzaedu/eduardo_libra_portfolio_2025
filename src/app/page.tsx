...
export default function Home() {
  return (
    ...
    <div className="flex flex-col items-center w-full">
      {/* Hero Section - Infláveis Promocionais */}
      <section className="relative h-screen w-full overflow-hidden">
        {/* Background com gradient overlay */}
        <div 
          className="absolute inset-0 bg-gradient-to-r from-blue-900/80 to-purple-900/60"
          style={{ 
            backgroundImage: "url('/background_baloes_especiais_shape_special_hotairballoon_eduardolibra.jpg')",
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-white px-4">
          <h1 className="mb-6 text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight">
            ...
            <span className="block text-yellow-400">de Alto Impacto</span>
          </h1>
          <p className="mb-8 max-w-4xl text-lg md:text-xl lg:text-2xl leading-relaxed">
            Destaque sua marca com <strong>tendas infláveis</strong>, <strong>balões rooftop</strong> e <strong>infláveis promocionais personalizados</strong>. 
            Fabricação própria com mais de 25 anos de experiência.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 mb-8">
            <a href="https://api.whatsapp.com/send/?phone=5511975865565&text=Oi%21+Gostaria+de+um+or%C3%A7amento+para+infl%C3%A1veis+promocionais&type=phone_number&app_absent=0" target="_blank" rel="noopener noreferrer">
             ...
             <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
               ...
               <div className="bg-gray-50 rounded-2xl p-8">
                 <form className="space-y-6">
                   ...
                   <div>
                     <label htmlFor="tipo_inflavel" className="block text-sm font-medium text-gray-700 mb-2">
                       Tipo de Inflável *
                     </label>
                     <select
                       id="tipo_inflavel"
                       ...
                       className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                     >
                       <option value="">Selecione o tipo desejado</option>
                       <option value="tenda_inflavel">Tenda Inflável</option>
                       <option value="balao_rooftop">Balão Rooftop</option>
                       <option value="inflavel_promocional">Inflável Promocional</option>
                       <option value="replica_produto">Réplica de Produto</option>
                       <option value="mascote_inflavel">Mascote Inflável</option>
                   ...
                   <div>
                     ...
                     <select
                       ...
                       className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                     >
                       <option value="normal">⏳ Sem pressa - Prefiro um projeto detalhado</option>
                       <option value="medio">🗓️ Até 20 dias está ótimo</option>
                       <option value="urgente">🚀 Preciso o quanto antes - Evento próximo</option>
                       <option value="orcamento">💰 Quero só ter uma ideia de preço</option>
                     </select>
                   </div>
                   ...
                   <div className="flex items-center">
                     ...
                     />
                     <label htmlFor="aceito_comunicacoes" className="ml-2 block text-sm text-gray-700">
               ...
               <div className="space-y-8">
                   ...
                   <div className="space-y-6">
                     <div className="flex items-start space-x-4">
                       ...
                       <div>
                         ...
                         <p className="text-gray-600 mb-2">Resposta rápida e atendimento personalizado</p>
                         <a 
                     ...
                     <div className="flex items-start space-x-4">
                       ...
                       <div>
                         ...
                         <p className="text-gray-600 mb-2">Para orçamentos detalhados e projetos complexos</p>
                         <a 
                     ...
                     <div className="flex items-start space-x-4">
                       ...
                       <div>
                         ...
                         <p className="text-gray-600">Horário de almoço: 12h às 13h</p>
                       </div>
                     </div>
                   </div>
                 </div>
                 ...
                 <div className="bg-blue-50 rounded-2xl p-6">
                   <h4 className="text-lg font-bold text-gray-900 mb-4">Vantagens do nosso orçamento:</h4>
