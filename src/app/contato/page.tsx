...
export default function ContatoPage() {
  return (
    <div className="container mx-auto py-8 sm:py-12 lg:py-16 px-4 sm:px-6 lg:px-8">
      ...
      <div className="bg-neutral-50 dark:bg-neutral-900 p-4 sm:p-6 lg:p-12 rounded-lg mb-8 sm:mb-12 lg:mb-16 max-w-4xl mx-auto">
        <h2 className="text-xl sm:text-2xl font-bold mb-6 sm:mb-8 text-center px-2">Solicite um Orçamento Personalizado</h2>
        <div className="space-y-4 sm:space-y-6">
          <div>
            <label htmlFor="tipo" className="block text-sm font-medium mb-2">Tipo de Arte Inflável</label>
            <select id="tipo" className="w-full rounded-md border border-neutral-300 dark:border-neutral-700 bg-white dark:bg-neutral-800 px-3 py-2.5 text-sm sm:text-base">
          ...
          <div>
            ...
            <select id="dimensoes" className="w-full rounded-md border border-neutral-300 dark:border-neutral-700 bg-white dark:bg-neutral-800 px-3 py-2.5 text-sm sm:text-base">
              <option value="">Selecione uma opção</option>
          ...
          <div>
            ...
            <select id="localizacao" className="w-full rounded-md border border-neutral-300 dark:border-neutral-700 bg-white dark:bg-neutral-800 px-3 py-2.5 text-sm sm:text-base">
              <option value="">Selecione uma opção</option>
          ...
          <div>
            ...
            <textarea
              id="descricao"
              rows={5}
              className="w-full rounded-md border border-neutral-300 dark:border-neutral-700 bg-white dark:bg-neutral-800 px-3 py-2.5 text-sm sm:text-base resize-none"
          ...
          <div className="grid grid-cols-1 gap-4 sm:gap-6">
            <div>
              ...
              <input
                type="text"
                id="nome"
                className="w-full rounded-md border border-neutral-300 dark:border-neutral-700 bg-white dark:bg-neutral-800 px-3 py-2.5 text-sm sm:text-base"
              />
            </div>
            <div>
          ...
          <Button className="w-full bg-primary hover:bg-primary/90 text-white border-primary hover:border-primary/90 py-4 sm:py-6 text-base sm:text-lg">
            Enviar Solicitação de Orçamento
          </Button>
        </div>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-16 items-start max-w-5xl mx-auto">
        {/* Seção de Contato */}
        <div className="bg-card p-4 sm:p-6 lg:p-10 rounded-lg shadow-md">
          <h2 className="text-xl sm:text-2xl font-bold mb-6 sm:mb-8 text-center px-2">Contato Direto</h2>
          <div className="space-y-6 sm:space-y-8">
            <div className="text-center mb-6 sm:mb-10">
              <p className="mb-6 sm:mb-8 text-sm sm:text-base px-2">Prefere falar diretamente? Entre em contato pelo WhatsApp:</p>
              <Button 
                className="w-full bg-green-600 hover:bg-green-700 text-white border-green-600 hover:border-green-700 py-4 sm:py-6 text-base sm:text-lg"
                onClick={() => {
                  if (typeof window !== 'undefined' && window.gtag_report_conversion) {
                    window.gtag_report_conversion('https://api.whatsapp.com/send/?phone=5511975865565&text=Oi+Eduardo%21+Eu+vim+através+do+site%2C+gostaria+de+conversar+sobre+uma+obra+de+arte+inflável&type=phone_number&app_absent=0');
                  } else {
                    window.open('https://api.whatsapp.com/send/?phone=5511975865565&text=Oi+Eduardo%21+Eu+vim+através+do+site%2C+gostaria+de+conversar+sobre+uma+obra+de+arte+inflável&type=phone_number&app_absent=0', '_blank');
                  }
                }}
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="mr-2 sm:mr-3">
        ...
        <div className="bg-card p-4 sm:p-6 lg:p-10 rounded-lg shadow-md">
          <h2 className="text-xl sm:text-2xl font-bold mb-6 sm:mb-8 text-center px-2">Informações</h2>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <button 
                  ...
                  className="text-muted-foreground hover:text-primary cursor-pointer bg-transparent border-none"
                >
                  +55 (11) 97586-5565
                </button>
              </div>
      ...
      <div className="mt-12 sm:mt-16 lg:mt-24">
        <h2 className="text-xl sm:text-2xl font-bold mb-6 sm:mb-8 text-center px-2">Exemplos de Obras de Arte Infláveis</h2>
        <p className="text-sm sm:text-base text-center text-muted-foreground max-w-2xl mx-auto mb-8 sm:mb-12 px-2 sm:px-4">
