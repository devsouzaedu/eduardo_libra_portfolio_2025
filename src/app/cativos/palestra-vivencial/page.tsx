    ...
    <div className="container mx-auto py-12 px-4">
      ...
      <div className="relative rounded-xl overflow-hidden h-[400px] md:h-[500px] mb-12">
        <Image 
          ...
          priority
        />
        <div className="absolute inset-0 bg-gradient-to-r from-black/50 to-transparent flex flex-col justify-center p-8 md:p-12">
          ...
          <p className="text-lg md:text-xl text-white/95 max-w-xl mb-8">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            >
              <Button variant="outline" className="border-white text-white hover:bg-white hover:text-blue-600 py-2 px-6 text-lg hover:scale-105 transition-all">
      ...
      <div className="mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white dark:bg-neutral-700 p-8 rounded-xl shadow-md hover:shadow-lg transition-all">
            <div className="w-16 h-16 bg-blue-100 dark:bg-blue-600 rounded-full flex items-center justify-center mb-6 mx-auto">
              <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-blue-600 dark:text-blue-100">
      ...
      <div className="mb-16">
        ...
        <div className="space-y-12">
          ...
          <div className="bg-white dark:bg-neutral-700 p-8 rounded-xl shadow-md">
            ...
            <ul className="list-disc pl-16 space-y-3 text-gray-600 dark:text-gray-200">
          ...
          <div className="bg-white dark:bg-neutral-700 p-8 rounded-xl shadow-md">
            ...
            <div className="pl-16">
              ...
              <ul className="list-disc pl-6 space-y-3 mb-6 text-gray-600 dark:text-gray-200">
              ...
              <ul className="list-disc pl-6 space-y-3 text-gray-600 dark:text-gray-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white dark:bg-neutral-700 p-6 rounded-xl shadow-md">
            <div className="flex items-start">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-blue-500 mr-4 mt-1 flex-shrink-0">
      ...
      {/* CTA Final */}
      <div className="bg-white dark:bg-neutral-700 p-8 md:p-12 rounded-xl text-center shadow-md">
        <h2 className="text-3xl font-bold mb-6">Transforme sua Equipe com uma Experiência Única</h2>
        <p className="text-lg mb-8 max-w-3xl mx-auto text-gray-600 dark:text-gray-200">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <a 
            ...
            rel="noopener noreferrer"
          >
            <Button variant="outline" className="border-blue-500 text-blue-500 dark:border-blue-400 dark:text-blue-400 hover:bg-blue-500 hover:text-white py-3 px-8 text-lg hover:scale-105 transition-all">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="mr-2">
                <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/>
              </svg>
              Falar pelo WhatsApp
